                    ...
                    <li class="dropdown nav-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownLanguage">
                            <a class="dropdown-item text-brand" href="#"><img
                                    src="{{ asset('admin/assets/imgs/theme/flag-us.png') }}" alt="English">English</a>
                            <a class="dropdown-item" href="#"><img
                                    src="{{ asset('admin/assets/imgs/theme/flag-fr.png') }}" alt="Français">Français</a>
                            <a class="dropdown-item" href="#"><img
                                    src="{{ asset('admin/assets/imgs/theme/flag-jp.png') }}" alt="Français">日本語</a>
                            <a class="dropdown-item" href="#"><img
                                    src="{{ asset('admin/assets/imgs/theme/flag-cn.png') }}" alt="Français">中国人</a>
                        </div>
                    </li>
                    <li class="dropdown nav-item">
                        <a class="dropdown-toggle" data-bs-toggle="dropdown" href="#" id="dropdownAccount"
                            aria-expanded="false"> <img class="img-xs rounded-circle"
                                src="{{ asset('admin/assets/imgs/people/avatar2.jpg') }}" alt="User"></a>
        ...
        <section class="content-main mt-80 mb-80">
            <div class="card mx-auto card-login">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.login_user') }}" method="POST">
                        ...
                        <div class="mb-3">
                            <input class="form-control" name="email" value="{{ old('email') }}"
                                placeholder="Username or email" type="email">
                            @error('email')
                        ...
                        <div class="mb-3">
                            ...
                            @if (session('error_password'))
                                <div class="text-danger">{{ session('error_password') }}</div>
                            @endif
                    ...
                    <p class="text-center mb-4">Don't have account? <a href="{{route('admin.registerPage')}}">Register</a></p>
                </div>
            </div>
        </section>
